...
const characterImages = {
        "Judy Hopps": "image/Judy.PNG",
        "Nick Wilde": "image/Nick.PNG", 
        "Chief Bogo": "image/Chief Bogo.PNG",
        "Officer Clawhauser": "image/Officer Clawhauser.PNG",
        "Mr. Big": "image/Mr.Big.PNG",
        "Fru Fru": "image/FruFru.jpg",
        "Dawn Bellwether": "image/Dawn Bellwether.jpg",
        "Mayor Lionheart": "image/Mayor Lionheart.PNG",
        "Gazelle": "image/Gazelle.PNG",
...
function startQuiz() {
    currentQuestion = 0;
    scores = {H:0, R:0, I:0, L:0, G:0, A:0, F:0, J:1}; 
    userAnswers = {};
    hideAllSections();
...
function showResult() {
    ...
    if (characterImage && characterImages[character]) {
        characterImage.src = characterImages[character];
        characterImage.alt = character;
        console.log("✅ 设置图片:", characterImages[character]);
    } else {
        console.error("❌ 找不到图片或图片元素:", character);
    }
    hideAllSections();
